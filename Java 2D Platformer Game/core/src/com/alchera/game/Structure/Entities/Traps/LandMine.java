 ...
 */
public class LandMine extends BaseTrap {

    private final int SpriteSize = 30;
    private float rotation;

    public LandMine(World world,float x,float y) {
        this.sprite = new Sprite(new Texture(Gdx.files.internal("sprites/mine.png")));
